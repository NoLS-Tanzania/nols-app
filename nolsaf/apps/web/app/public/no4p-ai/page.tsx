...
export default function No4PAIPage() {
  return (
    <main
      className="min-h-screen bg-slate-950 pt-20 text-slate-50"
      style={{ backgroundColor: "#050B10" }}
    >
      {/* Hero */}
      <div className="mx-auto w-full max-w-[1200px] px-4 sm:px-6">
        <div className="relative rounded-t-3xl p-[1px] shadow-2xl shadow-emerald-500/10">
          <div className="pointer-events-none absolute inset-0 rounded-t-3xl bg-gradient-to-r from-emerald-400/35 via-sky-400/20 to-fuchsia-400/25" />
          <section className="relative overflow-hidden rounded-t-3xl bg-[#050B10] ring-1 ring-white/10">
