...
export default function Page() {
        ...
        try {
          ...
          if (summaryRes.ok) {
            ...
            if (contentType && contentType.includes("application/json")) {
              ...
              // For now, we'll use activeSessions as a base and estimate by role
              // In a real implementation, you'd fetch sessions with user roles
              const activeSessions = summaryData?.activeSessions || 0;
              
              // Estimate distribution (you can replace this with actual role-based queries)
          ...
          // Fallback values if summary endpoint fails
          setOnlineUsers(0);
          setOnlineDrivers(0);
          setOnlineOwners(0);
          setOnlineAdmins(0);
  ...
  // Bookings vs Properties chart data
    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-center">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-5xl">
          <a href="/admin/management/settings" className="group block rounded-lg border border-gray-200 bg-white p-6 hover:border-[#02665e]/30 hover:shadow-md transition-all duration-200 no-underline relative overflow-hidden">
          ...
          <a href="/admin/management/audit-log" className="group block rounded-lg border border-gray-200 bg-white p-6 hover:border-sky-300 hover:shadow-md transition-all duration-200 no-underline relative overflow-hidden">
          ...
          <a href="/admin/management/users" className="group block rounded-lg border border-gray-200 bg-white p-6 hover:border-emerald-300 hover:shadow-md transition-all duration-200 no-underline relative overflow-hidden">
          ...
          <div className="group bg-white rounded-lg border border-gray-200 p-6 shadow-sm hover:shadow-lg hover:border-[#02665e]/30 hover:-translate-y-1 transition-all duration-300 cursor-pointer">
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h3 className="text-lg font-semibold text-gray-900 group-hover:text-[#02665e] transition-colors duration-300">Bookings vs Properties</h3>
              </div>
            ...
            <div className="mt-4 flex gap-4 text-sm">
              <div className="flex items-center gap-2 group-hover:translate-x-1 transition-transform duration-300">
                ...
                <span className="text-gray-600">Bookings: <span className="font-semibold text-gray-900">{bookingsCount.toLocaleString()}</span></span>
              </div>
              <div className="flex items-center gap-2 group-hover:translate-x-1 transition-transform duration-300">
                <div className="w-3 h-3 rounded bg-[#0ea5a0] group-hover:scale-125 transition-transform duration-300"></div>
                <span className="text-gray-600">Properties: <span className="font-semibold text-gray-900">{propertiesCount.toLocaleString()}</span></span>
              </div>
            </div>
          </div>

          {/* Platform Interactions/Analytics Card */}
          <div className="group bg-white rounded-lg border border-gray-200 p-6 shadow-sm hover:shadow-lg hover:border-sky-300 hover:-translate-y-1 transition-all duration-300 cursor-pointer">
            <div className="mb-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <h3 className="text-lg font-semibold text-gray-900 group-hover:text-sky-600 transition-colors duration-300">Platform Analytics</h3>
              </div>
