    ...
    <div className="min-h-[60vh] px-4 py-6 flex items-start justify-center">
      <div className="w-full max-w-4xl text-center">
        ...
        <div className="mt-4 grid md:grid-cols-2 gap-4">
          <a href="/owner/properties/add" className="group no-underline block rounded-xl border border-gray-200 p-4 bg-white shadow-sm hover:shadow-xl hover:bg-gray-50 hover:translate-y-[1px] transition duration-200 border-l-4 border-brand-primary">
          ...
          <a href="/owner/properties/pending" className="group no-underline block rounded-xl border border-gray-200 p-4 bg-white shadow-sm hover:shadow-xl hover:bg-gray-50 hover:translate-y-[1px] transition duration-200 border-l-4 border-brand-primary">
            <div className="flex items-center gap-2">
          ...
          <a href="/owner/bookings/checked-in" className="group no-underline block rounded-xl border border-gray-200 p-4 bg-white shadow-sm hover:shadow-xl hover:bg-gray-50 hover:translate-y-[1px] transition duration-200 border-l-4 border-brand-primary">
            <div className="flex items-center gap-2">
          ...
          <a href="/owner/reports/revenue" className="group no-underline block rounded-xl border border-gray-200 p-4 bg-white shadow-sm hover:shadow-xl hover:bg-gray-50 hover:translate-y-[1px] transition duration-200 border-l-4 border-brand-primary">
            <div className="flex items-center gap-2">
