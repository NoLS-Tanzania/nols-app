...
const fieldClass = "min-h-11 min-w-0 w-full rounded-md border border-neutral-300 bg-white px-3 text-sm text-neutral-900 outline-none transition placeholder:text-neutral-400 hover:border-neutral-400 focus:border-emerald-700 focus:ring-2 focus:ring-emerald-700/10";
