...
export default function DriverLiveMapTopControls({ 
  ...
  const buttonBase = [
    `pointer-events-auto ${compact ? "h-10 w-10" : "h-11 w-11"} rounded-full flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 hover:scale-110 active:scale-95 border`,
