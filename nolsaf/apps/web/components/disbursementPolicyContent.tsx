  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          <strong>4.2.1 Mobile Money Services:</strong> M-Pesa, Airtel Money, Tigo Pesa, HaloPesa, and other supported mobile money platforms. Property Owners and Drivers must provide valid, active mobile money numbers registered in their name.
        </p>
        <p>
