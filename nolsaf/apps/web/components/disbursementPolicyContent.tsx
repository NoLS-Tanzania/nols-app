...
export const DISBURSEMENT_POLICY_LAST_UPDATED = "1 January 2026";

export const DISBURSEMENT_POLICY_SECTIONS: TermsSection[] = [
  {
    title: "1. General Overview",
    content: (
      <div className="space-y-4">
        <p>
          This Disbursement Policy governs how NoLSAF processes and disburses payments to Property Owners and Drivers for services rendered through the NoLSAF platform. This policy applies exclusively to Property Owners and Drivers who are registered and active on the platform. All disbursements are processed digitally in accordance with NoLSAF&apos;s cashless payment principle, as outlined in section 1.3.4 of our <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link>.
        </p>
        <p>
          <strong>1.1 Applicability</strong><br />
          This policy applies to all Property Owners and Drivers who receive earnings, commissions, or payouts through the NoLSAF platform. By registering as a Property Owner or Driver and accepting payments through NoLSAF, you acknowledge that you have read, understood, and agree to be bound by this Disbursement Policy.
        </p>
        <p>
          <strong>1.2 Cashless Payment Principle</strong><br />
          NoLSAF operates on a cashless payment system. All payments from Users are processed digitally through NoLSAF&apos;s secure payment system, and all disbursements to Property Owners and Drivers are made through digital payment methods only. Cash payments are not accepted for disbursements, except in exceptional circumstances as outlined in section 1.3.4 of our <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link>, which applies to User payments only, not disbursements.
        </p>
        <p>
          <strong>1.3 Payment Flow</strong><br />
          As outlined in section 1.3.3 of our <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link>, all payments made by Users are directed to NoLSAF accounts first. Subsequently, NoLSAF disburses the appropriate amounts to Property Owners and Drivers in accordance with established agreements and payout schedules defined in this Disbursement Policy.
        </p>
      </div>
    ),
  },
  {
    title: "2. Rights of Property Owners and Drivers",
    content: (
      <div className="space-y-4">
        <p>
  ...
  {
    title: "3. Responsibilities of Property Owners and Drivers",
    content: (
      <div className="space-y-4">
        <p>
          <strong>3.1 Account Information Accuracy</strong><br />
          Property Owners and Drivers are responsible for maintaining accurate and up-to-date payment account information in their NoLSAF dashboard. This includes bank account details, mobile money numbers, or other payment method information required for disbursements.
        </p>
        <p>
          <strong>3.1.1 Verification Requirements:</strong> All payment account information must be verified before disbursements can be processed. Property Owners and Drivers must provide valid, active payment accounts that match their registered identity on the platform.
        </p>
        <p>
          <strong>3.1.2 Update Obligations:</strong> Property Owners and Drivers must promptly update their payment information if their account details change, are closed, or become invalid. Failure to maintain accurate payment information may result in delayed or failed disbursements.
        </p>
        <p>
          <strong>3.2 Tax and Legal Compliance</strong><br />
          Property Owners and Drivers are solely responsible for complying with all applicable tax laws, regulations, and reporting requirements in their jurisdiction. NoLSAF may provide transaction records to assist with tax reporting, but Property Owners and Drivers are responsible for calculating, reporting, and paying all applicable taxes on their earnings.
        </p>
        <p>
          <strong>3.2.1 Tax Documentation:</strong> Property Owners and Drivers must provide accurate tax identification information when required by law or requested by NoLSAF. Failure to provide required tax information may result in withholding of disbursements until compliance is achieved.
        </p>
        <p>
          <strong>3.2.2 Record Keeping:</strong> Property Owners and Drivers are responsible for maintaining their own records of earnings and disbursements for tax and accounting purposes. NoLSAF provides transaction history through the platform, but Property Owners and Drivers should maintain independent records.
        </p>
        <p>
          <strong>3.3 Service Delivery Obligations</strong><br />
          Property Owners and Drivers must fulfill their service delivery obligations as outlined in the <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link> to be eligible for disbursements. Disbursements are contingent upon successful completion of services and User satisfaction.
        </p>
        <p>
        ...
        <p>
          <strong>3.3.2 Driver Responsibilities:</strong> Drivers must provide safe, reliable, and punctual transportation services as outlined in section 1.9.3 of the <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link>. Disbursements may be delayed or withheld if services are not delivered as agreed or if there are unresolved disputes with Users.
        </p>
        <p>
          <strong>3.4 Communication Responsibilities</strong><br />
          Property Owners and Drivers are responsible for responding promptly to communications from NoLSAF regarding disbursements, account verification, or payment-related matters. Failure to respond may result in delayed disbursements.
        </p>
        <p>
          <strong>3.5 Platform Compliance</strong><br />
          Property Owners and Drivers must comply with all NoLSAF platform policies, terms of service, and community guidelines to remain eligible for disbursements. Violations of platform policies may result in suspension of disbursements or account termination.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          Property Owners and Drivers are strongly advised and encouraged to provide all payment method information and complete verification during the initial registration and onboarding process when joining the NoLSAF platform. Completing payment method setup and verification during registration ensures timely disbursements once services begin and earnings are generated.
        </p>
        <p>
          <strong>4.1.1 Registration Payment Setup:</strong> During the registration process, Property Owners and Drivers should provide their preferred payment method information, including all required account details, and initiate the verification process immediately upon account creation.
        </p>
        <p>
          <strong>4.1.2 Early Verification Benefits:</strong> Completing payment method verification during registration allows Property Owners and Drivers to receive disbursements immediately upon earning their first payments, without delays associated with post-registration verification processes.
        </p>
        <p>
          <strong>4.1.3 Multiple Payment Methods:</strong> Property Owners and Drivers may provide multiple payment method options during registration, though only one primary payment method will be active for disbursements at any given time. Having multiple verified payment methods provides flexibility and backup options.
        </p>
        <p>
          <strong>4.1.4 Registration Verification Process:</strong> The verification process during registration follows the same requirements outlined in section 4.2.1 (Verification Process), including OTP verification from NoLSAF and any additional verification steps required.
        </p>
        <p>
          <strong>4.1.5 Incomplete Registration Payment Setup:</strong> If payment method information is not provided or verified during registration, Property Owners and Drivers must complete this process before they can receive any disbursements. Earnings will accumulate in their account until payment method verification is completed.
        </p>
        <p>
          <strong>4.2 Digital Payment Methods</strong><br />
          All disbursements to Property Owners and Drivers are processed exclusively through digital payment methods. NoLSAF supports the following digital payment methods for disbursements:
        </p>
        <p>
          <strong>4.2.1 Mobile Money Services:</strong> M-Pesa, Airtel Money, Mixx by Yas, HaloPesa, and other supported mobile money platforms. Property Owners and Drivers must provide valid, active mobile money numbers registered in their name.
        </p>
        <p>
          <strong>4.2.2 Bank Transfers:</strong> Direct bank transfers to verified bank accounts. Property Owners and Drivers must provide accurate bank account details including account number, bank name, branch, and account holder name matching their registered identity.
        </p>
        <p>
        ...
        <p>
          ...
          Property Owners and Drivers must select and configure their preferred payment method through their NoLSAF dashboard. Only one primary payment method can be active at a time, though Property Owners and Drivers may update their payment method as needed. Property Owners and Drivers who completed payment method setup during registration can activate their verified payment method immediately.
        </p>
        <p>
          <strong>4.4 Verification Process:</strong> All payment methods must undergo verification before disbursements can be processed. Verification is mandatory and includes multiple security steps to ensure the security and accuracy of payment information. Property Owners and Drivers who complete verification during registration will have their payment methods ready for immediate use once they begin earning.
        </p>
        <p>
          <strong>4.4.1 One-Time Password (OTP) Verification:</strong> NoLSAF requires OTP verification as part of the payment method verification process. Property Owners and Drivers will receive a one-time password from NoLSAF via SMS or email to the registered contact information. This OTP must be entered within the specified time limit to complete the verification process. OTP verification is required both during registration and for any subsequent payment method changes.
        </p>
        <p>
        ...
        <p>
          <strong>4.4.2.2</strong> Completing identity verification to confirm that the payment account matches the registered Property Owner or Driver identity on the platform.
        </p>
        <p>
        ...
        <p>
          <strong>4.4.3 Verification Timeline:</strong> Verification processes may take 1-5 business days to complete, depending on the payment method selected and the completeness of documentation provided. Property Owners and Drivers will be notified of verification status through their dashboard and via email. Verification completed during registration may be processed more quickly as part of the onboarding workflow.
        </p>
        <p>
          <strong>4.4.4 Verification Failure:</strong> If verification fails due to incorrect information, expired OTP, or incomplete documentation, Property Owners and Drivers must restart the verification process. Multiple failed verification attempts may result in temporary restrictions on payment method changes or account activation.
        </p>
        <p>
          <strong>4.4.5 Verification Requirements:</strong> All verification requirements must be completed before any disbursements can be processed to the payment method. Unverified payment methods will not receive disbursements, and earnings will remain in the Property Owner&apos;s or Driver&apos;s account until verification is completed. Property Owners and Drivers are strongly advised to complete verification during registration to avoid delays in receiving their first disbursements.
        </p>
        <p>
          <strong>4.5 Payment Method Changes:</strong> Property Owners and Drivers may change their payment method through their dashboard, but all changes must undergo the same verification process outlined in section 4.4 above, including OTP verification from NoLSAF.
        </p>
        <p>
          <strong>4.5.1 Change Verification Requirements:</strong> When changing a payment method, Property Owners and Drivers must complete the full verification process, including OTP verification, before the new payment method can be activated for disbursements.
        </p>
        <p>
          <strong>4.5.2 Timing of Changes:</strong> Changes made during an active payout period may delay disbursements until verification is completed. Property Owners and Drivers are advised to update payment methods well in advance of expected payout dates to avoid delays.
        </p>
        <p>
        ...
        <p>
          <strong>4.5.4 Security Measures:</strong> Payment method changes are subject to additional security measures, including OTP verification, to prevent unauthorized changes and protect Property Owner and Driver accounts.
        </p>
        <p>
          <strong>4.6 Payment Method Limitations</strong><br />
          Some payment methods may have limitations, including minimum disbursement amounts, maximum transaction limits, or geographic restrictions. Property Owners and Drivers will be informed of any applicable limitations when selecting their payment method during registration or when updating payment methods.
        </p>
        <p>
          <strong>4.7 Failed Disbursements</strong><br />
          If a disbursement fails due to incorrect payment information, closed accounts, or other payment method issues, NoLSAF will attempt to notify the Property Owner or Driver. The Property Owner or Driver must update their payment information promptly and complete verification. Failed disbursements may incur additional processing fees as outlined in section 6 (Fees and Deductions).
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          <strong>5.1.2 Driver Payout Eligibility:</strong> Drivers become eligible to claim payouts after completing trips and meeting the minimum trip completion requirements. Drivers can claim payouts for individual trips or accumulated earnings from multiple completed trips, subject to the time limitations outlined in section 5.2 below.
        </p>
        <p>
          <strong>5.1.2.1 Trip Completion Requirements:</strong> Drivers must complete trips as agreed and receive trip completion confirmation before earnings become eligible for payout claims. The specific number of trips or minimum earnings required may vary based on driver agreements.
        </p>
        <p>
          <strong>5.1.2.2 Individual or Accumulated Claims:</strong> Drivers can choose to claim payouts for individual completed trips or wait to accumulate earnings from multiple trips before claiming. Drivers have the flexibility to claim payouts based on their preferences and financial needs.
        </p>
        <p>
          <strong>5.1.3 Payout Claim Process:</strong> Property Owners and Drivers can initiate payout claims through their NoLSAF dashboard using the established claim process. The claim process includes verification steps to ensure security and accuracy.
        </p>
        <p>
        ...
        <p>
          <strong>5.2.1 Maximum Unclaimed Period:</strong> Property Owners and Drivers must claim their payouts within a maximum period that does not exceed the agreed payout schedule. Unclaimed payouts exceeding the maximum period will be automatically processed according to the standard payout schedule or as agreed between the Property Owner, Driver, and NoLSAF.
        </p>
        <p>
          <strong>5.2.2 Automatic Disbursement:</strong> If Property Owners or Drivers do not claim their payouts within the maximum unclaimed period, NoLSAF will automatically process the disbursement according to the established payout schedule or agreement. Property Owners and Drivers will be notified before automatic disbursement occurs.
        </p>
        <p>
          <strong>5.2.3 Notification of Unclaimed Payouts:</strong> NoLSAF will send notifications to Property Owners and Drivers when payouts become eligible for claim and as the maximum unclaimed period approaches. Notifications will be sent through the dashboard and via email to ensure Property Owners and Drivers are aware of their available payouts.
        </p>
        <p>
          <strong>5.3 Payout Agreements</strong><br />
          Property Owners and Drivers may enter into specific payout agreements with NoLSAF that establish customized payout schedules, subject to the limitations outlined in this section.
        </p>
        <p>
          <strong>5.3.1 Daily Payout Agreements:</strong> Property Owners and Drivers may request daily payout agreements, where eligible earnings are automatically disbursed on a daily basis. Daily payout agreements are subject to minimum threshold requirements and payment method limitations.
        </p>
        <p>
          <strong>5.3.2 Weekly Payout Agreements:</strong> Property Owners and Drivers may request weekly payout agreements, where eligible earnings are automatically disbursed on a weekly basis. Weekly payout agreements are the maximum frequency allowed, and no payout agreements may exceed weekly disbursements.
        </p>
        <p>
        ...
        <p>
          <strong>5.3.4 Agreement Modifications:</strong> Property Owners and Drivers may request modifications to their payout agreements, but changes are subject to approval and may require a verification period before taking effect. No payout agreement may exceed weekly disbursement frequency.
        </p>
        <p>
        ...
        <p>
          <strong>5.4.3 Delayed Disbursements:</strong> If a disbursement is delayed beyond 24 hours after claim initiation or automatic trigger, Property Owners and Drivers should contact NoLSAF support immediately. NoLSAF will investigate the delay and provide updates on the disbursement status.
        </p>
        <p>
          <strong>5.4.4 Support Contact for Delays:</strong> Property Owners and Drivers experiencing disbursement delays beyond 24 hours should contact NoLSAF support at <a href="mailto:info@nolsaf.com" className="text-blue-600 hover:text-blue-800 underline">info@nolsaf.com</a> or through the <Link href="/help" className="text-blue-600 hover:text-blue-800 underline">Help Center</Link>. Support team will investigate and resolve delays promptly.
        </p>
        <p>
          <strong>5.4.5 NoLSAF Notifications:</strong> NoLSAF will provide notifications to Property Owners and Drivers in case of disbursement delays, system issues, or other circumstances that may affect payout processing. Notifications will be sent through the dashboard and via email.
        </p>
        <p>
          <strong>5.5 Minimum Payout Threshold</strong><br />
          NoLSAF may establish minimum payout thresholds to ensure efficient processing and reduce transaction costs. Earnings below the minimum threshold will accumulate in the Property Owner&apos;s or Driver&apos;s account until the threshold is reached or until a payout claim is made, whichever comes first.
        </p>
        <p>
          <strong>5.5.1 Threshold Amounts:</strong> Minimum payout thresholds may vary by payment method and will be clearly communicated to Property Owners and Drivers through their dashboard. Thresholds may be adjusted with advance notice as outlined in section 12 (Amendments to Disbursement Policy).
        </p>
        <p>
          <strong>5.5.2 Threshold Exceptions:</strong> Property Owners and Drivers may be able to claim payouts below the minimum threshold in certain circumstances, such as account closure, termination of services, or special agreements with NoLSAF. Such exceptions are subject to approval and may incur additional processing fees.
        </p>
        <p>
          <strong>5.6 Payout Processing Time by Payment Method</strong><br />
          Once a disbursement is initiated, the time for funds to appear in the Property Owner&apos;s or Driver&apos;s account depends on the payment method selected. Processing times may vary:
        </p>
        <p>
        ...
        <p>
          <strong>5.2 Minimum Payout Threshold</strong><br />
          NoLSAF may establish minimum payout thresholds to ensure efficient processing and reduce transaction costs. Earnings below the minimum threshold will accumulate in the Property Owner&apos;s or Driver&apos;s account until the threshold is reached.
        </p>
        <p>
          <strong>5.2.1 Threshold Amounts:</strong> Minimum payout thresholds may vary by payment method and will be clearly communicated to Property Owners and Drivers through their dashboard. Thresholds may be adjusted with advance notice as outlined in section 12 (Amendments to Disbursement Policy).
        </p>
        <p>
          <strong>5.2.2 Accumulation Period:</strong> Earnings below the minimum threshold will remain in the Property Owner&apos;s or Driver&apos;s account and will be disbursed once the threshold is reached or upon account closure, whichever comes first.
        </p>
        <p>
          <strong>5.3 Payout Processing Time</strong><br />
          Once a payout is initiated, the time for funds to appear in the Property Owner&apos;s or Driver&apos;s account depends on the payment method selected. Processing times may vary:
        </p>
        <p>
          <strong>5.3.1 Mobile Money:</strong> Typically 1-3 business days after payout initiation.
        </p>
        <p>
          <strong>5.3.2 Bank Transfers:</strong> Typically 3-5 business days after payout initiation, depending on the bank and country.
        </p>
        <p>
          <strong>5.3.3 Payment Platforms:</strong> Processing times vary by platform and may take 3-7 business days.
        </p>
        <p>
          <strong>5.4 Delayed Payouts</strong><br />
          Payouts may be delayed due to various reasons, including but not limited to: pending disputes, account verification issues, incomplete documentation, platform maintenance, or payment provider delays. Property Owners and Drivers will be notified of any significant delays through their dashboard or via email.
        </p>
        <p>
          <strong>5.5 Expedited Payouts</strong><br />
          NoLSAF may offer expedited payout options for Property Owners and Drivers, subject to availability and applicable fees. Expedited payout terms and fees will be clearly communicated when available.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          NoLSAF charges commissions and service fees on bookings and services, which are deducted from gross earnings before disbursement. The commission structure and rates are established in the agreement between NoLSAF and each Property Owner or Driver during the registration process.
        </p>
        <p>
        ...
        <p>
          <strong>6.1.3 Commission Rates:</strong> Commission rates may vary based on property type, service category, volume, or special agreements established during registration. Property Owners and Drivers can view their applicable commission rates through their dashboard. The commission rate agreed upon during registration will be applied consistently unless modified through mutual agreement or as outlined in section 12 (Amendments to Disbursement Policy).
        </p>
        <p>
          <strong>6.1.4 Transparent Deductions:</strong> All commission and service fee deductions are clearly itemized in transaction records and payout statements. Property Owners and Drivers can view detailed breakdowns of all deductions, including base price disbursements and commission calculations, through their dashboard.
        </p>
        <p>
          <strong>6.2 Transaction and Processing Fees</strong><br />
          Property Owners and Drivers may be subject to transaction fees or processing fees associated with disbursements, depending on the payment method selected. These fees are deducted from the disbursement amount.
        </p>
        <p>
          <strong>6.2.1 Payment Method Fees:</strong> Different payment methods may have different fee structures. Property Owners and Drivers will be informed of applicable fees when selecting their payment method.
        </p>
        <p>
          <strong>6.2.2 Failed Transaction Fees:</strong> If a disbursement fails due to incorrect payment information provided by the Property Owner or Driver, additional fees may apply for reprocessing. Property Owners and Drivers are responsible for ensuring accurate payment information.
        </p>
        <p>
        ...
        <p>
          ...
          Property Owners and Drivers may be subject to penalties or fines for violations of platform policies, terms of service, or failure to deliver services as agreed. These penalties will be deducted from earnings before disbursement.
        </p>
        <p>
          <strong>6.5 Tax Withholding</strong><br />
          NoLSAF may be required by law to withhold taxes from disbursements in certain jurisdictions. If tax withholding is required, the withheld amount will be deducted from the disbursement, and Property Owners and Drivers will receive appropriate tax documentation.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          Gross earnings are calculated based on completed bookings, trips, or services rendered through the NoLSAF platform. The calculation method varies for Property Owners and Drivers.
        </p>
        <p>
          <strong>7.1.1 Property Owner Gross Earnings:</strong> Calculated as the total booking amount paid by Users, excluding any taxes, service charges, or fees that are separately collected or managed by the Property Owner outside the platform.
        </p>
        <p>
          <strong>7.1.2 Driver Gross Earnings:</strong> Calculated based on completed trips, distance traveled, time, and applicable rates as established in the driver agreement and platform pricing structure.
        </p>
        <p>
        ...
        <p>
          ...
          Property Owners and Drivers can access detailed earnings statements through their NoLSAF dashboard, showing gross earnings, all deductions, and net earnings for each transaction and payout period.
        </p>
        <p>
  ...
  {
    title: "9. Duties of Property Owners and Drivers",
    content: (
      <div className="space-y-4">
        <p>
          <strong>8.1 Duty to Maintain Accurate Information</strong><br />
          Property Owners and Drivers have a duty to maintain accurate, current, and complete information in their NoLSAF accounts, including payment information, contact details, and identification documents. This duty is ongoing and requires prompt updates when information changes.
        </p>
        <p>
          <strong>8.2 Duty to Deliver Services</strong><br />
          Property Owners and Drivers have a duty to deliver services as agreed and described in bookings or service agreements. This duty includes meeting quality standards, adhering to schedules, and fulfilling all service obligations as outlined in the <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link>.
        </p>
        <p>
          <strong>8.2.1 Property Owner Duties:</strong> Property Owners must provide accommodations that match their listings, maintain property standards, ensure guest safety, and comply with all booking terms and local regulations.
        </p>
        <p>
          <strong>8.2.2 Driver Duties:</strong> Drivers must provide safe, reliable, and punctual transportation services, maintain valid licenses and insurance, ensure vehicle safety, and comply with all traffic laws and regulations as outlined in section 1.9.3 of the <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link>.
        </p>
        <p>
          <strong>8.3 Duty to Resolve Disputes</strong><br />
          Property Owners and Drivers have a duty to cooperate in resolving disputes with Users or NoLSAF. This includes responding to dispute notifications, providing requested information, and participating in dispute resolution processes in good faith.
        </p>
        <p>
          <strong>8.4 Duty to Comply with Platform Policies</strong><br />
          Property Owners and Drivers have a duty to comply with all NoLSAF platform policies, terms of service, community guidelines, and applicable laws and regulations. Non-compliance may result in suspension of disbursements or account termination.
        </p>
        <p>
          <strong>8.5 Duty to Report Issues</strong><br />
          Property Owners and Drivers have a duty to promptly report any issues, errors, or discrepancies related to their earnings, disbursements, or account information to NoLSAF through the appropriate support channels.
        </p>
        <p>
          <strong>8.6 Duty to Maintain Service Standards</strong><br />
          Property Owners and Drivers have a duty to maintain high service standards and professional conduct, as their performance directly impacts User satisfaction and the reputation of the NoLSAF platform.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          ...
          NoLSAF has a responsibility to provide Property Owners and Drivers with transparent, accurate, and accessible information about their earnings, deductions, and disbursements through the platform dashboard.
        </p>
        <p>
          <strong>10.6 Responsibility to Secure Transactions</strong><br />
          NoLSAF has a responsibility to maintain secure payment processing systems and protect Property Owner and Driver financial information, as outlined in section 1.9.1(c) of the <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link>.
        </p>
      </div>
    ),
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          <strong>10.4.1 Submission Channels:</strong> Disputes must be submitted through the NoLSAF platform support system, by contacting NoLSAF at <a href="mailto:info@nolsaf.com" className="text-blue-600 hover:text-blue-800 underline">info@nolsaf.com</a>, or through the <Link href="/help" className="text-blue-600 hover:text-blue-800 underline">Help Center</Link>. Disputes submitted through other channels may not be processed.
        </p>
        <p>
          <strong>10.4.2 Submission Timeframe:</strong> Disputes must be submitted within 30 days of the occurrence that gave rise to the dispute, or within 30 days of the Property Owner becoming aware of the issue, whichever is later. Disputes submitted after this timeframe may not be considered.
        </p>
        <p>
          <strong>10.4.3 Required Information:</strong> Property Owners must provide the following information when submitting a dispute: booking reference number, date of the incident, description of the dispute, specific policy sections in question, requested resolution, and all relevant documentation.
        </p>
        <p>
          <strong>10.5 Dispute Documentation Requirements</strong><br />
          Property Owners must provide comprehensive documentation to support their dispute claims.
        </p>
        <p>
          <strong>10.5.1 Required Documentation:</strong> Property Owners must provide detailed documentation supporting their dispute, including but not limited to: transaction records, booking confirmations, cancellation notices, refund notifications, communication records with Users, screenshots, emails, payment receipts, service delivery confirmations, and any other relevant evidence.
        </p>
        <p>
          <strong>10.5.2 Documentation Standards:</strong> All documentation must be clear, legible, complete, and directly relevant to the dispute. Documentation that is unclear, incomplete, or irrelevant may not be considered in the dispute resolution process.
        </p>
        <p>
          <strong>10.5.3 Additional Documentation Requests:</strong> NoLSAF may request additional documentation or information during the dispute review process. Property Owners must provide such documentation within the specified timeframe, typically within 7 business days of the request.
        </p>
        <p>
          <strong>10.5.4 Consequences of Incomplete Documentation:</strong> Disputes submitted without adequate supporting documentation, or where requested additional documentation is not provided, may be resolved based on available information, which may result in an unfavorable outcome for the Property Owner.
        </p>
        <p>
          <strong>10.6 Dispute Review Process</strong><br />
          NoLSAF will conduct a thorough review of all disputes in accordance with applicable policies and established procedures.
        </p>
        <p>
          <strong>10.6.1 Review Timeline:</strong> NoLSAF will review disputes within 14-21 business days of submission, provided all required documentation has been received. Complex disputes or disputes requiring additional investigation may take longer, and Property Owners will be notified of any delays.
        </p>
        <p>
          <strong>10.6.2 Policy Application:</strong> During the review process, NoLSAF will apply the relevant provisions of the Cancellation Policy, Terms of Service, Privacy Policy, and this Disbursement Policy to determine the appropriate resolution. NoLSAF&apos;s interpretation of these policies is final, subject to applicable legal rights.
        </p>
        <p>
          <strong>10.6.3 Investigation Process:</strong> NoLSAF may conduct investigations, contact Users, review booking records, examine communication logs, verify service delivery, and take any other actions necessary to resolve the dispute fairly and in accordance with applicable policies.
        </p>
        <p>
          <strong>10.6.4 Property Owner Participation:</strong> Property Owners may be required to participate in the review process by providing additional information, clarifying statements, or participating in discussions. Property Owners must respond promptly to all requests during the review process.
        </p>
        <p>
          <strong>10.6.5 Interim Communication:</strong> NoLSAF may provide updates on the dispute review process, request additional information, or seek clarification from Property Owners during the review period. Property Owners should monitor their communication channels for such requests.
        </p>
        <p>
          <strong>10.7 Dispute Resolution Outcomes</strong><br />
          Dispute resolutions will be determined based on the application of applicable policies and the evidence provided.
        </p>
        <p>
          <strong>10.7.1 Possible Outcomes:</strong> Dispute resolutions may result in: correction of earnings or disbursements, adjustment of deductions, reversal of charges, confirmation that the original calculation was correct, partial adjustments, or other resolutions deemed appropriate based on the circumstances and applicable policies.
        </p>
        <p>
          <strong>10.7.2 Policy-Based Decisions:</strong> All dispute resolutions will be based on the terms and conditions outlined in the Cancellation Policy, Terms of Service, Privacy Policy, and this Disbursement Policy. NoLSAF&apos;s decision will reflect the application of these policies to the specific circumstances of the dispute.
        </p>
        <p>
          <strong>10.7.3 Finality of Decisions:</strong> NoLSAF&apos;s decision on disputes is final, subject to applicable legal rights and the appeal process outlined in section 10.8 below. Property Owners must accept and comply with NoLSAF&apos;s dispute resolution decisions.
        </p>
        <p>
          <strong>10.7.4 Implementation of Resolutions:</strong> Once a dispute is resolved, NoLSAF will implement the resolution by adjusting earnings, processing refunds or reversals, updating disbursement schedules, or taking other actions as determined by the resolution. Property Owners will be notified of the resolution and any actions taken.
        </p>
        <p>
          <strong>10.7.5 Binding Nature:</strong> Property Owners agree that NoLSAF&apos;s dispute resolution decisions are binding and must be complied with. Failure to comply with a dispute resolution decision may result in account suspension, withholding of disbursements, or other actions as outlined in section 9.2 (Right to Withhold Disbursements).
        </p>
        <p>
          <strong>10.8 Appeal Process</strong><br />
          Property Owners who disagree with a dispute resolution may submit an appeal under specific conditions.
        </p>
        <p>
          <strong>10.8.1 Appeal Eligibility:</strong> Property Owners may submit one appeal within 14 days of receiving the dispute resolution decision. Appeals must be based on new evidence or information that was not previously considered, or on claims that NoLSAF&apos;s decision was not in accordance with applicable policies.
        </p>
        <p>
          <strong>10.8.2 Appeal Submission:</strong> Appeals must be submitted through the same channels as initial disputes, clearly marked as an appeal, and must include: the original dispute reference number, the reason for the appeal, new evidence or information (if applicable), and a detailed explanation of why the original decision should be reconsidered.
        </p>
        <p>
          <strong>10.8.3 Appeal Review:</strong> Appeals will be reviewed by a different NoLSAF representative or team than the original dispute. The appeal review will consider the new evidence or information, verify policy compliance, and make a final determination.
        </p>
        <p>
          <strong>10.8.4 Finality of Appeals:</strong> NoLSAF&apos;s decision on appeals is final and binding. No further appeals or reconsiderations will be available through NoLSAF&apos;s internal processes, though Property Owners retain any applicable legal rights.
        </p>
        <p>
          <strong>10.9 Resolution of User-Initiated Conflicts</strong><br />
        ...
        <p>
          <strong>10.9.1 User Complaint Resolution:</strong> When Users file complaints that may result in refunds, chargebacks, or other financial adjustments, Property Owners must cooperate with NoLSAF&apos;s investigation and resolution process. Property Owners must provide all requested information and documentation related to the User&apos;s complaint.
        </p>
        <p>
          <strong>10.9.2 Cancellation Request Handling:</strong> When Users request cancellations in accordance with the Cancellation Policy, Property Owners must comply with the cancellation terms and cooperate with NoLSAF&apos;s processing of refunds or adjustments as outlined in section 6.3 (Refunds and Chargebacks).
        </p>
        <p>
          <strong>10.9.3 Refund Claim Cooperation:</strong> When Users claim refunds under the Cancellation Policy, Property Owners must provide all necessary information and documentation to assist NoLSAF in determining refund eligibility. Property Owners must accept NoLSAF&apos;s determination of refund eligibility based on the Cancellation Policy.
        </p>
        <p>
          <strong>10.9.4 Chargeback Response:</strong> When chargebacks are initiated by Users, Property Owners must cooperate with NoLSAF&apos;s chargeback dispute process by providing evidence of service delivery, booking fulfillment, and any other documentation required to dispute the chargeback. Property Owners must respond promptly to all chargeback-related requests.
        </p>
        <p>
          <strong>10.9.5 Alternative Resolution Measures:</strong> In some cases, NoLSAF may propose alternative resolution measures such as partial refunds, future booking credits, or other accommodations to resolve User conflicts. Property Owners must consider and cooperate with such alternative measures when proposed by NoLSAF.
        </p>
        <p>
          <strong>10.10 Consequences of Non-Cooperation</strong><br />
          Property Owners who fail to cooperate with NoLSAF&apos;s dispute resolution measures may face consequences.
        </p>
        <p>
          <strong>10.10.1 Withholding of Disbursements:</strong> NoLSAF may withhold disbursements until Property Owners comply with cooperation requirements and participate fully in the dispute resolution process.
        </p>
        <p>
          <strong>10.10.2 Resolution Based on Available Information:</strong> If Property Owners fail to provide requested information or documentation, NoLSAF may resolve the dispute based solely on available information, which may result in an unfavorable outcome for the Property Owner.
        </p>
        <p>
          <strong>10.10.3 Account Actions:</strong> Persistent non-cooperation may result in account suspension, restrictions on platform access, or other actions as outlined in the Terms of Service and section 9.2 (Right to Withhold Disbursements) of this policy.
        </p>
        <p>
          <strong>10.10.4 Policy Violation:</strong> Failure to cooperate with dispute resolution measures may constitute a violation of the Terms of Service and this Disbursement Policy, which may result in penalties, fines, or termination of the platform relationship.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          NoLSAF reserves the right to amend this Disbursement Policy at any time to reflect changes in business practices, legal requirements, payment processing capabilities, or industry standards. Significant changes will be communicated to Property Owners and Drivers via email or through notifications on the platform at least 21 days prior to the changes taking effect.
        </p>
        <p>
          <strong>12.2 Applicability</strong><br />
          The version of the Disbursement Policy in effect at the time a service is rendered or a disbursement is processed will apply to that transaction. Property Owners and Drivers are encouraged to review the current Disbursement Policy regularly.
        </p>
        <p>
          <strong>12.3 Acceptance</strong><br />
          By continuing to use the NoLSAF platform and receive disbursements after policy changes take effect, Property Owners and Drivers acknowledge and agree to be bound by the updated Disbursement Policy. If Property Owners or Drivers do not agree with the updated policy, they should discontinue using the platform for receiving payments.
        </p>
      </div>
    ),
  },
    ...
    content: (
      <div className="space-y-4">
        <p>
          ...
          NoLSAF is committed to maintaining the confidentiality of all financial information, payment details, earnings data, and account information related to Property Owners and Drivers. All disbursement-related information is treated as confidential and is protected in accordance with our <Link href="/privacy" className="text-blue-600 hover:text-blue-800 underline">Privacy Policy</Link>.
        </p>
        <p>
          <strong>13.2 Disclosure Limitations</strong><br />
          NoLSAF will not disclose Property Owner or Driver financial information, earnings, or disbursement details to third parties except as required by law, as necessary to process disbursements, or with explicit consent from the Property Owner or Driver.
        </p>
        <p>
          <strong>13.3 Data Security</strong><br />
          NoLSAF employs industry-standard security measures to protect all financial and payment information. Property Owners and Drivers are responsible for maintaining the confidentiality of their account credentials and should not share their login information with unauthorized parties.
        </p>
        <p>
          <strong>13.4 Authorized Access</strong><br />
          Property Owners and Drivers may access their own disbursement information through their secure dashboard. NoLSAF personnel with authorized access to disbursement information are bound by confidentiality obligations and may only access such information for legitimate business purposes.
        </p>
      </div>
    ),
  },
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          For questions, concerns, or assistance regarding this Disbursement Policy, earnings, or disbursements, Property Owners and Drivers can contact NoLSAF:
        </p>
        <p>
          ...
          <strong>Platform:</strong> Access customer support through your Property Owner or Driver dashboard
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        ...
        <p>
          <strong>Disbursement:</strong> The process of transferring earnings from NoLSAF to Property Owners or Drivers through digital payment methods. Disbursements are processed according to payout schedules and terms outlined in this policy.
        </p>
        <p>
        ...
        <p>
          <strong>Earnings:</strong> The amount of money earned by Property Owners or Drivers for services rendered through the NoLSAF platform. Earnings include gross earnings (before deductions) and net earnings (after deductions).
        </p>
        <p>
        ...
        <p>
          <strong>Gross Earnings:</strong> The total amount earned by Property Owners or Drivers from completed bookings or trips, before any deductions for commissions, fees, refunds, or other adjustments.
        </p>
        <p>
        ...
        <p>
          <strong>Net Earnings:</strong> The amount remaining after all deductions (commissions, fees, refunds, chargebacks, penalties, tax withholdings) are subtracted from gross earnings. Net earnings represent the actual amount disbursed to Property Owners or Drivers.
        </p>
        <p>
        ...
        <p>
          <strong>Payout:</strong> The actual transfer of funds to Property Owners or Drivers. Payouts are processed according to payout schedules, which may be flexible (on-demand) or scheduled (daily/weekly), as outlined in section 5 of this policy.
        </p>
        <p>
        ...
        <p>
          <strong>User:</strong> An individual who books accommodations or services through the NoLSAF platform. Users make payments to NoLSAF, which are then disbursed to Property Owners or Drivers after service completion.
        </p>
        <p>
  ...
  },
  {
    ...
    content: (
      <div className="space-y-4">
        <p>
          By registering as a Property Owner or Driver on the NoLSAF platform and accepting disbursements, you acknowledge that you have read, understood, and agree to be bound by this Disbursement Policy. You further acknowledge that you understand your rights, responsibilities, and duties as outlined in this policy.
        </p>
        <p>
          Property Owners and Drivers are encouraged to review this Disbursement Policy regularly and contact NoLSAF support if they have any questions or require clarification about any aspect of this policy. NoLSAF is committed to providing clear, fair, and transparent disbursement terms to ensure a positive experience for all Property Owners and Drivers.
        </p>
        <p>
          This Disbursement Policy works in conjunction with the <Link href="/terms" className="text-blue-600 hover:text-blue-800 underline">Terms of Service</Link> and other applicable NoLSAF policies. Property Owners and Drivers must comply with all applicable policies to remain eligible for disbursements.
        </p>
      </div>
    ),
  },
