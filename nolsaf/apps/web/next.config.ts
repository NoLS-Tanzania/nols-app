...
const nextConfig: NextConfig = {
  ...
  async rewrites() {
    return [
      ...
      // Exclude Next page routes under /admin/management/* and user detail pages from being proxied to the API.
      { source: '/admin/:path((?!management/.*|users/\\d+$).*)', destination: 'http://127.0.0.1:4000/admin/:path*' },
