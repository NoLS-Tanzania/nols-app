...
import { colors, NolsafLogoMark } from "@nolsaf/native-ui";
  ...
  return (
    <View style={styles.bootRoot}>
      ...
      <View style={styles.bootCenter}>
        ...
        <Text style={styles.bootBrand}>NoLSAF Driver</Text>
        <Text style={styles.bootCaption}>Preparing your driver tools</Text>
      </View>
    </View>
  );
}
